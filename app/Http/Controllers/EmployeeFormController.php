...
class EmployeeFormController extends Controller
{
    ...
    public function store(Request $request, $code)
    {
        ...
        // Check if employee already exists for this form
        $employee = Employee::where('form_id', $form->id)->first();

        // Handle file uploads
        if ($request->hasFile('passport_photo')) {
            // Delete old file if updating
            if ($employee && $employee->passport_photo) {
            ...
            // Keep existing file if updating, null if creating
            $passportPhotoPath = $employee ? $employee->passport_photo : null;
        }
        ...
        if ($request->hasFile('signature')) {
            ...
            // Keep existing file if updating, null if creating
            $signaturePath = $employee ? $employee->signature : null;
        }
